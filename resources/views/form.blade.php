...
@section('content')
    ...
    <form action="{{url('pkm/add')}}" method="post" enctype="multipart/form-data" id="new_pkm">
        ...
        <div class="form-group">
            ...
            <input type="title" class="form-control" id="exampleInputTitle" placeholder="Judul" name="title"
        ...
        <div class="form-group">
            ...
            <input type="leader" class="form-control" id="exampleInputLeader" placeholder="Nama Ketua" name="leader"
                   value="{{Input::old('leader')}}">
        ...
        <div class="form-group">
            <label>Tahun</label>
            <input type="year" class="form-control" id="exampleInputYear" placeholder="Tahun" name="year"
        ...
        <div class="form-group">
            ...
            <br>
            @for($i = 0; $i<4;$i++)
                <input type="radio" name="status" value="{{$i}}" name="status"
                       value="{{Input::old('status')}}">{{$status[$i]}}
                <br>
            @endfor
        ...
        <div class="form-group">
            ...
            <textarea class="responsive-area" cols="100" rows="5" name="description" form="new_pkm">
            </textarea>
